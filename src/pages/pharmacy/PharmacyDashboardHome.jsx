...
// import dummyPharmacies from './dummydata';
// import { FaStore, FaMoneyBillAlt, FaMapMarkerAlt } from 'react-icons/fa'; // Import icons
...
//                     <FaStore className="mr-4 text-3xl" /> {/* Pharmacy Icon */}
//                     <div>
...
//                 <div className="bg-blue-600 text-white rounded-lg shadow p-4 flex items-center">
//                     <FaMoneyBillAlt className="mr-4 text-3xl" /> {/* Revenue Icon */}
//                     <div>
...
//                 <div className="bg-blue-600 text-white rounded-lg shadow p-4 flex items-center">
//                     <FaMapMarkerAlt className="mr-4 text-3xl" /> {/* Location Icon */}
//                     <div>
